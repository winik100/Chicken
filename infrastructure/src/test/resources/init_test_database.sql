...
VALUES (1, 999999, 'iwas fuer info',  '2022-03-08 10:00:00', '2022-03-08 11:00:00', 'praesenz');
INSERT INTO "klausur" (id, "lsf_id", NAME, START, ENDE, TYP)
VALUES (2, 888888, 'iwas anderes fuer info',  '2022-03-08 11:00:00', '2022-03-08 12:00:00', 'praesenz');

INSERT INTO "student" (id, "github_handle", "rest_urlaub")
VALUES (1, 'testhandle_1', 240);
INSERT INTO "student_belegt_klausur" (ID, KLAUSUR_ID)
VALUES (1, 1);

INSERT INTO "student" (id, "github_handle", "rest_urlaub")
VALUES (2, 'testhandle_2', 120);
INSERT INTO "urlaubs_eintrag" (id, start, ende, "student_id")
VALUES (1, '2022-03-17 09:30:00', '2022-03-17 11:30:00', 2);
INSERT INTO "student_belegt_klausur" (ID, KLAUSUR_ID)
VALUES (2, 1);

INSERT INTO "student" (id, "github_handle", "rest_urlaub")
VALUES (3, 'testhandle_3', 0);
INSERT INTO "urlaubs_eintrag" (id, start, ende, "student_id")
VALUES (3, '2022-03-17 09:30:00' , '2022-03-17 11:30:00', 3);
INSERT INTO "urlaubs_eintrag" (id, start, ende, "student_id")
VALUES (4, '2022-03-18 10:30:00' , '2022-03-18 12:30:00', 3);
INSERT INTO "student_belegt_klausur" (ID, KLAUSUR_ID)
VALUES (3, 2);

INSERT INTO "student" (id, "github_handle", "rest_urlaub")
VALUES (4, 'testhandle_4', 180);
INSERT INTO "urlaubs_eintrag" (id, start, ende, "student_id")
VALUES (5, '2022-03-17 09:30:00' , '2022-03-17 10:30:00', 4);