...
public class ChickenConfiguration {
    @Bean
    public StudentService studentenServiceErstellen(StudentRepository studentRepo) {
    ...
    @Bean
    public BuchungsService buchungsServiceErstellen(StudentRepository studentRepo,
                                                    KlausurRepository klausurRepo,
                                                    BuchungsValidierung buchungsValidierung) throws IOException {
