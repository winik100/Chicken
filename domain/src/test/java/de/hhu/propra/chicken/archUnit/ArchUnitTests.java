...
public class ArchUnitTests {
    ...
    void test_2(){
        ArchRule rule = noClasses().should().beAnnotatedWith(Deprecated.class);
    ...
    void test_3(){
        ArchRule rule = noMethods().should().beAnnotatedWith(Deprecated.class);
    ...
    void test_4(){
        ArchRule rule = noConstructors().should().beAnnotatedWith(Deprecated.class);
    ...
    void test_6(){
        ArchRule rule = fields().that().areDeclaredInClassesThat().areAnnotatedWith(AggregateRoot.class).should().notBePublic();
